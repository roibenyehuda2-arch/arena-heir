...
Taunting costs no energy, recovers 10, cannot be used within melee reach, and holds a one-turn cooldown. It leaves the rival rattled, cutting the accuracy of their next physical attack by 12 points. That positional restriction is what makes the crowd a decision rather than a button.
