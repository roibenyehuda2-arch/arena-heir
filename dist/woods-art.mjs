...
export function drawDwarf(ctx,art,x,y,{time=0,walk=0,moving=false,face=1,weapon=0,armor=0,attack=null,dodge=0,hurt=0,scale=1}={}){
 ...
 function leg(x,a){ctx.save();ctx.translate(x,-61);ctx.rotate(a);part(3,-19,0,40,65);ctx.restore();}
